 function searchFood(id){
	 console.log(id);
	   $.post("http://localhost/myidealportion/getFood", { id: id, systemId: "" },
      		 function(response) {
   ...
   var searchFood = function(){
        ...
        var film = $('#term').val();
         ...
         if(film == ''){
            ...
            $.post("http://localhost/myidealportion/getCategory", { value: document.getElementById("term").value, systemId: "" },
            		 function(response) {
